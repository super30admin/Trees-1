class ConstructTreeFromPreAndInorder{
    ...
    // time complexity :o(n)
    //space complexity : o(1) since we are just passing index no extra space is used other than preorder,inorder and constructed tree
    //approach: find root node from pre order and based on root we can find left tree in order similarly construct full tree
}